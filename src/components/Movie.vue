                    ...
                    <div class="flip" v-for="(data) in movie_list" :key="data">
                        ...
                        <div class="back">
                            ...
                            <div class="row" style="position: absolute; bottom: 10px;">
                                <div class="col-sm-3">
                                    <b-button size="md" variant="outline-success" @click="Add_cart(data,'buy')"> Buy </b-button>
                                </div>
                                <div class="col-sm-5">
                                    <b-button size="md" variant="outline-primary" @click="Add_cart(data)"><span>
                                            <div class="fas fa fa-shopping-cart fa-lg" style="margin-right:5px"></div>
                                        </span>+ </b-button>
                                </div>
                                <div class="col-sm-4">
...
<div class="hvrbox-text">{{data.detail}}</div>
    ...
    <div class="overflow-auto" style="margin-left: auto; margin-right: auto;display: block;">
        <div @click="get_page">
            <b-pagination v-model="currentPage" :total-rows="rows" :per-page="perPage" align="center" first-number></b-pagination>
        </div>
    </div>
        ...
        list: function (data) {
            ...
            for (var i = 0; i < data.results.length; i++) {
                movie = {
                    ...
                    detail: data.results[i].overview,
                    image: "https://image.tmdb.org/t/p/original" + data.results[i].poster_path
                }
